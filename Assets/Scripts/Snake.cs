...
public class Snake : MonoBehaviour
{
    ...
    private float gridMoveTimerMax = 0.14f; // La serpiente se moverá a cada segundo
    ...
    private void HandleGridMovement() // Relativo al movimiento en 2D
    {
        ...
        if (gridMoveTimer >= gridMoveTimerMax)
        {
            ...
            {
                if (gridPosition == movePosition.GetGridPosition()&& funcionActiva==false) // Posición de la cabeza coincide con alguna parte del cuerpo
                {
                    GameOver();
                }
            }
